				...
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "0"),
						}),
					})},
					newErrResult(v),
				}}
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "3"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "5"),
					})},
				}}
			},
		}
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "4"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "6"),
					})},
				}}
			},
		}
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "2"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "7"),
					})},
				}}
			},
		}
				...
				if dst == ":6" {
					return &mockConn{
						DoFn: func(cmd Completed) RedisResult {
							return RedisResult{val: NewRedisMessage('*', []RedisMessage{NewRedisMessage('+', "slave")})}
						},
					}
				}
				if dst == ":7" {
					return &mockConn{
						DoFn: func(cmd Completed) RedisResult {
							return RedisResult{val: NewRedisMessage('*', []RedisMessage{NewRedisMessage('+', "master")})}
						},
					}
				}
				return nil
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					...
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "6"),
						}),
					})},
				}}
			},
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						...
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "32"),
						}),
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "31"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
						...
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "8"),
							NewRedisMessage('+', "s-down-time"), NewRedisMessage('+', "1"),
						}),
					})},
				}}
			},
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "5"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "7"),
						}),
					})},
				}}
			},
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('%', []RedisMessage{
							NewRedisMessage('+', "ip"), NewRedisMessage('+', ""),
							NewRedisMessage('+', "port"), NewRedisMessage('+', "1"),
						}),
					})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "2"),
					})},
				}}
			},
		}
		s1 := &mockConn{
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					...
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "3"),
					})},
				}}
			},
		}
		...
		s2 := &mockConn{
			...
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{
					...
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "4"),
					})},
				}}
			},
		}
		...
		DoMultiFn: func(multi ...Completed) *redisresults {
			if first {
				...
				return &redisresults{s: []RedisResult{
					{val: NewRedisMessage('*', []RedisMessage{})},
					{val: NewRedisMessage('*', []RedisMessage{
						NewRedisMessage('+', ""), NewRedisMessage('+', "1"),
					})},
				}}
			}
...
func TestSentinelClientDelegate(t *testing.T) {
	...
	t.Run("Delegate MGetCache", func(t *testing.T) {
		...
		m.DoMultiFn = func(cmd ...Completed) *redisresults {
			...
			return &redisresults{s: []RedisResult{
				newResult(NewRedisMessage('+', "master"), nil),
			}}
		}
	...
	t.Run("Delegate DoMulti", func(t *testing.T) {
		...
		m.DoMultiFn = func(cmd ...Completed) *redisresults {
			...
			return &redisresults{s: []RedisResult{newResult(NewRedisMessage('+', "Do"), nil)}}
		}
	...
	t.Run("Delegate DoMultiCache", func(t *testing.T) {
		...
		m.DoMultiCacheFn = func(multi ...CacheableTTL) *redisresults {
			...
			return &redisresults{s: []RedisResult{newResult(NewRedisMessage('+', "DoCache"), nil)}}
		}
	...
	t.Run("Dedicated Delegate", func(t *testing.T) {
		w := &mockWire{
			...
			DoMultiFn: func(cmd ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{newResult(NewRedisMessage('+', "Delegate"), nil)}}
			},
			ReceiveFn: func(ctx context.Context, subscribe Completed, fn func(message PubSubMessage)) error {
				return ErrClosing
			},
	...
	setup := func(t *testing.T) (client *sentinelClient, cb func()) {
		...
		m2 := &mockConn{
			DoFn: func(cmd Completed) RedisResult {
				...
				return RedisResult{val: NewRedisMessage('+', "OK")}
			},
			DoMultiFn: func(multi ...Completed) *redisresults {
				return &redisresults{s: []RedisResult{{val: NewRedisMessage('+', "OK")}}}
			},
			DoCacheFn: func(cmd Cacheable, ttl time.Duration) RedisResult {
				return RedisResult{val: NewRedisMessage('+', "OK")}
			},
...
func TestSentinelClientPubSub(t *testing.T) {
	...
	m4 := &mockConn{
		DoFn: func(cmd Completed) RedisResult {
			...
			return RedisResult{val: NewRedisMessage('+', "OK4")}
		},
	...
	SetupClientRetry(t, func(m *mockConn) Client {
		m.DoOverride = map[string]func(cmd Completed) RedisResult{
			"SENTINEL SENTINELS masters": func(cmd Completed) RedisResult {
				return RedisResult{val: NewRedisMessage('*', []RedisMessage{})}
			},
